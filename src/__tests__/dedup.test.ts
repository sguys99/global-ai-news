...
describe("normalizeUrl", () => {
  ...
  it("utm_* / ref 트래킹 쿼리를 제거한다", () => {
    expect(normalizeUrl("https://example.com/a?utm_source=x&ref=y&id=1")).toBe(
...
describe("dedupKey", () => {
  it("정규화 결과가 같으면 동일한 키", () => {
    expect(dedupKey("https://example.com/a/?utm_source=x")).toBe(dedupKey("https://EXAMPLE.com/a"));
  });
